...
public record ChatInviteLink(
        ...
        String name,
        User creator,
        @SerializedName("expire_date") Integer expireDate,
        @SerializedName("member_limit") Integer memberLimit,
        @SerializedName("pending_join_request_count") Integer pendingJoinRequestCount,
        @SerializedName("subscription_period") Integer subscriptionPeriod,
        @SerializedName("subscription_price") Integer subscriptionPrice,
        @SerializedName("is_primary") Boolean isPrimary,
        @SerializedName("is_revoked") Boolean isRevoked,
        @SerializedName("creates_join_request") Boolean createsJoinRequest
) {}