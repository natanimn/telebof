...
public class KeyboardButtonRequestChat implements Serializable {
    ...
    /**
     * Required
     * @param request_id Signed 32-bit identifier of the request, which will be received back in the {@link io.github.natanimn.telebof.types.chat_and_user.ChatShared} object.
