 ...
 * @author Natanim
 * @since 3 March 2025
 * @implNote {@link BotContext#getMyCommands}
 */
public class GetMyCommands extends AbstractBaseRequest<GetMyCommands, List<BotCommand> > {
    ...
    /**
     * Optional
     * @param bot_command_scope A JSON-serialized object, describing scope of users. Defaults to {@link io.github.natanimn.types.bot.BotCommandScopeDefault}.
