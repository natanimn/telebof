 ...
 * @since 3 March 2025
 * @version 0.9
 * @implNote {@link io.github.natanimn.BotContext#editMessageText}
 */
public class EditMessageText extends AbstractBaseRequest<EditMessageText, Object> {
     ...
     * @implNote {@link io.github.natanimn.BotContext#editMessageText(String, Object, int)}
     */
     ...
     * @param requestSender request sender
     * @implNote {@link io.github.natanimn.BotContext#editMessageText(String, String)}
     */
