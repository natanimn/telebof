...
public class SendVoice extends SendBuilder<SendVoice, Message> {
     ...
     * @implNote {@link io.github.natanimn.BotContext#sendVoice(Object, String)}
     */
    public SendVoice(Object chat_id, String voice, RequestSender requestSender) {
        super(chat_id, requestSender, "sendVoice");
        add("voice", voice);
    }
     ...
     * @param voice File
     * @param requestSender request sender
     * @implNote {@link io.github.natanimn.BotContext#sendVoice(Object, File)}
     */
    public SendVoice(Object chat_id, File voice, RequestSender requestSender) {
        super(chat_id, requestSender, "sendVoice");
        add("voice", voice);
